  ...
  return (
    <div className={`${dmSans.className} bg-white`}>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Separator />
        <DetailsDescription category={mockProduct.category} ong={mockProduct.ong} region={mockProduct.region}/>
        <Separator />
        <ArtisanInfo artisanName={mockProduct.artisan.name} artisanPlace={mockProduct.artisan.place} artisanStory={mockProduct.artisan.story} />
        <Separator />
        <RelatedProducts />
      </div>
      <Footer />
