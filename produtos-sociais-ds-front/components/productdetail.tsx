  ...
  return (
    <div className={`${dmSans.className} bg-white`}>
        ...
        <nav className="flex items-center space-x-2 mb-8 text-sm">
            ...
            <Link href="/pernambuco" className="text-gray-600 hover:underline">Pernambuco</Link>
            <span className="text-gray-400">&gt;</span>
            <Link href="/grande-recife" className="text-gray-600 hover:underline">Grande Recife</Link>
            <span className="text-gray-400">&gt;</span>
            <Link href="/decoracao" className="text-gray-600 hover:underline">Decoração</Link>
            <span className="text-gray-400">&gt;</span>
            <Link href="/recife" className="text-gray-600 hover:underline">Recife</Link>
            <span className="text-gray-400">&gt;</span>
            <Link href="/caxanga" className="text-gray-600 hover:underline">Caxangá</Link>
        </nav>
